    ...
    <form id="form1" runat="server">
        <div>
            <table class="auto-style1">
                <tr>
                    <td style="font-size: 24px; font-weight: bolder">Productos</td>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="gvProductos" runat="server" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" AllowPaging="True" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" OnPageIndexChanging="gvProductos_PageIndexChanging" OnRowCancelingEdit="grv_ProductosRWcancelingedit" OnRowEditing="grd_ProductosRWediting" OnRowUpdating="grv_ProductosRWUpdating" OnRowDeleting="gvProductos_RowDeleting">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Nombre Producto">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtNombreProducto" runat="server" Text='<%# Bind("NombreProducto") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Cantidad por unidad">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtCantidadxUnidad" runat="server" Text='<%# Bind("CantidadPorUnidad") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Precio Unidad">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtPrecioxUnidad" runat="server" Text='<%# Bind("PrecioUnidad") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
